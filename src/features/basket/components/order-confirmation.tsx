...
export function OrderConfirmation() {
    ...
    // Генерация случайных номеров (имитация)
    ...
    return (
        <div className="animate-in fade-in zoom-in-95 duration-500">
            ...
            {/* Блок с номерами и штрихкодами */}
            <div className="bg-white mb-8">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-6">
                    {/* Логотип LabQuest (текстом или svg) */}
                ...
                <div className="text-sm font-bold text-[#333333] space-y-1 mb-8">
            ...
            {/* Зеленая плашка оплаты */}
            <div className="bg-[#EBF7D6] p-6 mb-8 flex items-center bg-opacity-50 relative overflow-hidden">
                {/* Декор снежинки (можно убрать) */}
                ...
                <div className="relative z-10">
                    <div className="font-bold text-[#333333] mb-1">Способ оплаты:</div>
                    <div className="font-bold text-xl text-[#333333]">Оплатить в офисе</div>
                </div>
            </div>

            {/* Состав заказа */}
            <div className="bg-[#F9FAFB] p-6 mb-8">
                <h3 className="font-bold text-lg text-[#333333] mb-4">Состав заказа</h3>
                        ...
                        <tbody>
                            ...
                            {items.map((item) => (
                                <tr key={item.id} className="border-b border-gray-100 last:border-0">
                                    <td className="py-4 px-2 text-gray-500">{item.article || item.id}</td>
                                    <td className="py-4 px-2 font-medium text-[#333333]">{item.name}</td>
                                    <td className="py-4 px-2 text-right font-bold text-[#333333]">{(item.price * item.quantity).toLocaleString()} руб.</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <div className="mb-8">
                <h3 className="font-bold text-lg text-[#333333] mb-4">Данные заказа</h3>
                <div className="text-sm text-[#333333] space-y-2 font-medium">
